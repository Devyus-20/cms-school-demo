...
<body class="bg-slate-100 font-sans text-slate-800 p-4 sm:p-8">
    ...
    <div class="max-w-4xl mx-auto mb-6 flex items-center justify-between no-print">
        <a href="{{ route('admin.reports.index', ['type' => 'ujian', 'exam_id' => $exam->id_exam]) }}" class="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-slate-800 text-white text-xs font-bold hover:bg-slate-900 transition-colors">
            ← Kembali ke Pusat Laporan
        </a>
        <div class="flex items-center gap-3">
            <a href="{{ route('admin.reports.export.ujian', ['exam_id' => $exam->id_exam]) }}" class="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold transition-colors">
                📥 Download Excel/CSV
            </a>
