...
<div class="max-w-xl space-y-5">
    <div class="flex items-center gap-3">
        ...
        <span class="text-sm text-slate-700 font-semibold">Tambah Permission Baru</span>
    </div>

    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
        <h3 class="text-base font-bold text-slate-800 mb-5">Informasi Permission</h3>
        <form action="{{ route('admin.permissions.store') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input name="name" required value="{{ old('name') }}"
                       ...
                       placeholder="Contoh: Kelola Posts">
            ...
            <div>
                ...
                <textarea name="description" rows="3"
                          ...
                          placeholder="Keterangan tentang permission ini...">{{ old('description') }}</textarea>
